"""Resolvedor exacto alternativo para validar la implementación principal."""
...
def max_pares_fuerza_bruta(
    ...
    """Calcula la solución óptima mediante búsqueda recursiva con memoización.

    Aunque en el proyecto se denomina "bruteforce", la implementación utiliza
    memoización para evitar recalcular subproblemas idénticos.
    """
    n = len(secuencia)
    memo = {}
